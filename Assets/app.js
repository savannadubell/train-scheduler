var config = {
    apiKey: "AIzaSyCi_ZGm6GPQ7h_Un4BgwzRrSVIgR5HNuWM",
    authDomain: "train-scheduler-be7bf.firebaseapp.com",
    databaseURL: "https://train-scheduler-be7bf.firebaseio.com",
    projectId: "train-scheduler-be7bf",
    storageBucket: "",
    messagingSenderId: "268978589114"
  };
  ...
  $("#submit").on("click", function(event) {
    ...
    if ($("#train-name").val().trim() === "" ||
      ...
      alert("If you want to add in a new train you need to fill out all the details");
